package com.popularmmos.entities.jenboss.subsidiaries.lightningPink;
...
public class RenderLightningPink extends Render
{
     ...
     */
    public void doRender(EntityLightningPink p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        for (int k1 = 0; k1 < 4; ++k1)
        {
            ...
            for (int j = 0; j < 3; ++j)
            {
                ...
                for (int i1 = k; i1 >= l; --i1)
                {
                    ...
                    tessellator.setColorRGBA_F(p_76986_1_.getRed(), p_76986_1_.getGreen(), p_76986_1_.getBlue(), 0.75F);
                    System.out.println("Correct Renderer, at least.");
     ...
     */
    protected ResourceLocation getEntityTexture(EntityLightningPink p_110775_1_)
    {
        return null;
    }
    ...
    {
        return this.getEntityTexture((EntityLightningPink)p_110775_1_);
    }
    ...
    {
        this.doRender((EntityLightningPink)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}
